...
class ListPage extends StatefulWidget {
  ...
  const ListPage({required this.admin});
  @override
...
class _ListPageState extends State<ListPage> {
  ...
  void deleteMahasiswa(String nokamar, String foto) async {
    var response =
                  ...
                  Material(
                    ...
                    child: InkWell(
                      onTap: () => showDialog(
                        ...
                        if (value == 'ok') {
                          deleteMahasiswa(mahasiswa.nokamar!, mahasiswa.foto!);
                          getMahasiswa();
                          setState(() {});
                        }
                      }),

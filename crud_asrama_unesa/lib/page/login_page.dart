...
class _LoginPageState extends State<LoginPage> {
  ...
  void login() async {
    if (_formKey.currentState!.validate()) {
      var response = await http.post(Uri.parse(ApiMahasiswa.URL_LOGIN), body: {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Exception Gagal Masuk');
      }
    }
  }
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: Colors.yellow, fontSize: 16),
